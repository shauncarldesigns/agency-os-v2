    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
      ...
      <Section title="1 · Lead info — copy into HoneyBook">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 8 }}>
          ...
          <CopyField label="Contact name" value={lead.contact ?? firstMinedOwner(lead.owner_names) ?? ''} copied={copied === 'contact'} onCopy={() => copy('contact', lead.contact ?? firstMinedOwner(lead.owner_names))} />
