  ...
  return (
    <div className="cockpit-page">
      ...
      <div className="cockpit-outcome-bar">
        ...
        <select defaultValue="" disabled={recording || bookingMode} onChange={(event) => { if (event.target.value) void recordOutcome('bad_contact', { badContactReason: event.target.value as SessionOutcomeBody['badContactReason'] }); }} className="cockpit-outcome-btn pr-10" aria-label="Unable to reach reason">
