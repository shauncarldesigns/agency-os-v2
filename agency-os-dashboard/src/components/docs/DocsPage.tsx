...
const DOCS: DocPage[] = [
  {
    id: 'warm-lead-sales-call',
    title: 'Warm-Lead Sales Call',
    eyebrow: 'Sales script',
    summary: 'Guide a prospect who has already seen the website from their reaction to the right plan.',
    icon: PhoneCall,
    sections: [
      {
        title: 'Opening',
        template: `“Hey [Name], it’s Shaun with Shaun Carl Designs. I’m the one who sent over the website I put together for [Company Name]. Did I catch you at an okay time?”

“Were you able to take a look at it?”

“Great. What stood out to you?”

Let them answer.

“What would you want changed or added if it were actually going to become your website?”

Let them talk about the design, photos, services, colors, wording, or anything that feels inaccurate.
...
“Absolutely. What I sent was really just a starting point based on what I could find online. We would customize all of that around your business.”`,
      },
      {
        ...
        template: `“The bigger question is what you need from it right now.”

“Are you mainly looking for a professional website so people have somewhere credible to go when they look you up, or are you actively trying to get found by more people and bring in more clients?”`,
      },
      {
        title: 'If they mainly need a professional presence',
        template: `“That sounds like the Build & Maintain plan.”

“We would take what you have already seen, customize it around your business, get everything approved, and launch it under your domain.”

“The website is $799, and then hosting and ongoing management are $79 per month. The hosting drops to $50 per month with a one-year commitment.”
...
“Great. Then the next step would be getting the agreement and initial payment taken care of, and we can start gathering the photos and business information needed to finish it.”`,
      },
      {
        title: 'If they need more clients',
        template: `“That sounds more like the Growth plan.”

“The website gives people a professional place to land, but a website by itself does not automatically bring in new clients.”

“The Growth plan includes the website, hosting, and the ongoing Google Business and local-search work designed to improve your visibility and help more people find you.”

“It’s $499 per month.”

“With a six-month commitment, the website build is reduced from $799 to $499. With a twelve-month commitment, the website build is waived.”

Then close:

“Does the six-month or twelve-month option make more sense for where you are right now?”`,
      },
      {
        title: 'If they are unsure which they need',
        template: `“Do you feel like you already have enough work and mainly need the business to look more professional online?”

“Or would you like us actively working each month to improve your visibility and help bring in additional opportunities?”

Then recommend the plan based on their answer.`,
      },
      {
        title: 'Condensed version',
        template: `“What did you think of the site?”

“What would you change or add if it were going to become your actual website?”

“Are you mainly looking for a professional online presence, or are you looking to get found by more people and bring in more clients?”

If presence:

“Then the Build & Maintain plan is probably the best fit. It’s $799 for the website and $79 per month for hosting and management—or $50 per month with a one-year commitment.”

If growth:

“Then I would recommend the Growth plan. It includes the website, hosting, and ongoing Google Business and local-search work for $499 per month. The website is $499 with six months or waived with twelve.”
...
“Does that sound like the right direction?”`,
  ...
  },
  {
    ...
    eyebrow: 'Post-sale script',
    summary: 'Move a verbal yes into agreement, payment, scheduled discovery, production, and launch.',
    icon: ArrowRightCircle,
    sections: [
      {
        title: 'After they choose a plan',
        template: `“Great. The next step is pretty straightforward.”

“I’ll send you the agreement for the [Build & Maintain / Growth] plan along with the initial deposit invoice.”

“Once the agreement is signed and the deposit is paid, we’ll schedule a discovery call to go through everything that needs to be included on the actual website.”`,
      },
      {
        title: 'Schedule the discovery call',
        callout: 'Do not leave the discovery call unscheduled. Choose a specific date and time before ending the sales call.',
        template: `“Let’s also get the discovery call on the calendar now so we can keep everything moving. What does your schedule look like over the next few days?”

Choose a specific date and time.

Then say:

“I’ll send the agreement and deposit invoice after this call. Once those are completed, we’ll be ready for discovery on [day and time].”`,
      },
      {
        title: 'Explain the discovery call',
        template: `“The discovery call is where we turn the concept you saw into your actual website.”

“We’ll go through what you want changed, the services you want emphasized, the areas you serve, your business story, photos, branding, frequently asked questions, and where you want calls and form submissions to go.”

“I’ll also collect anything you already have, such as your logo, project photos, brochures, social-media links, certifications, or other business information.”

“The goal is to leave that call with everything I need to finish the real website without repeatedly coming back to you with questions.”`,
      },
      {
        title: 'Explain the website process',
        template: `“After discovery, I’ll update the site using the information we collected.”

“That includes replacing any placeholder content, updating the wording and services, adding your real photos and branding, and making the changes we discussed.”

“I’ll then send the completed version to you for review.”

“You’ll be able to request changes to the text, photos, colors, videos, or design details before it goes live.”

“Once you approve it, you’ll purchase or provide access to the domain. You will own the domain, and I’ll handle connecting it to the website and setting up the technical side.”

“After the domain is connected and the final payment is completed, the website goes live.”`,
      },
      {
        title: 'Growth plan process',
        body: 'Add this explanation for a Growth client:',
        template: `“Once the website is live, the ongoing Growth work begins.”

“That includes the Google Business Profile and local-search work we discussed. The website becomes the foundation, and then we continue improving your visibility each month.”`,
      },
      {
        title: 'Full close',
        template: `“Great. I’ll send over the agreement and deposit invoice today, and we’ll schedule discovery for [day and time]. Once those are completed, we can start turning the site you saw into the finished website for your business.”`,
      },
      {
        title: 'Condensed closing version',
        template: `“Great. The next step is for me to send you the agreement and deposit invoice.”

“Once those are completed, we’ll have a discovery call to go through the actual content, services, service areas, photos, branding, and everything you want changed from the version you saw.”

“After discovery, I’ll complete the website and send it to you for review. Once you approve it, you’ll purchase or provide the domain, I’ll connect everything, and we’ll launch.”

“Let’s get the discovery call on the calendar now. What does your schedule look like over the next few days?”`,
      },
    ],
  },
  {
