...
import { TrendingUp, Plus, Play, RefreshCw, MapPin } from 'lucide-react';
      ...
      <section className="mb-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600"><TrendingUp size={19} /></span>
            <div>
              <h1 className="text-xl font-semibold tracking-tight text-slate-950">Research</h1>
              <p className="mt-0.5 text-sm text-slate-500">Demand and competition per market — is there search volume here, and who currently owns it.</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {markets.length > 0 && (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3.5 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50 disabled:opacity-50"
              >
