  ...
  return <Modal open={open} onClose={onClose} width={720}>
    ...
    <div className="p-5">
      {content ? <>
        ...
        <textarea value={content} readOnly onClick={(event) => (event.target as HTMLTextAreaElement).select()} spellCheck={false} className="min-h-96 max-h-[58vh] w-full resize-y whitespace-pre-wrap rounded-xl border border-slate-200 bg-slate-50 p-4 font-mono text-xs leading-relaxed text-slate-700" />
