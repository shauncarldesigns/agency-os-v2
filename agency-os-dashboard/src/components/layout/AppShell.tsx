...
const NAV: Array<{ section: string; items: NavItem[] }> = [
  {
    ...
    items: [
      ...
      { key: 'receptionist-interest', label: 'Receptionist', icon: PhoneIncoming, badgeKey: 'receptionistInterest' },
...
const PAGE_TITLES: Record<Tab, { title: string; subtitle: string }> = {
  ...
  'receptionist-interest': { title: 'Automated Receptionist', subtitle: 'Prepare personalized demos and review voice calls' },
